...
def run():
    ...
    results_prefix = "./04_results_terachem/" #../p26/strategy/data_file/snapshot*.pdb
    perturbed_prefix="./03_perturbed/"
    mtz_prefix="./02_mtz/"
    p26_pdb_prefix="./01d_fixSplit_GFA/"
    #
            ...
            #Loop over Snapshots
                ...
                for snapshot in snapshots:
                  if(snapshot.endswith("pdb")):
                    ...
                    #Execute job
                      cmd =  " ".join(["phenix.python ./qr-core/qrefine.py ",snapshotdir_name+snapshot, mtz_prefix+data_file, strategy,"update_all_scales=False use_r_free=False", "file_out_prefix="+output, "  >  ", output+ ".log" ])
                      print cmd
                      easy_run.call(cmd)
